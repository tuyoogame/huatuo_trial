...
namespace Huatuo.Perf.AOT
{
    ...
    [PerfClass("SieveOfEratosthenes", "AOT", "数值计算")]
    ...
    [PerfClass("PixarRaytracer", "AOT", "数值计算")]
    ...
    [PerfClass("FirefliesFlocking", "AOT", "数值计算")]
    ...
    // Polynomials
    [PerfClass("Polynomials", "AOT", "数值计算")]
    ...
    // Particle Kinematics
    [PerfClass("ParticleKinematics", "AOT", "数值计算")]
